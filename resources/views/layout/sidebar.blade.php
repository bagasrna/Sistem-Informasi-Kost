...
<body class="bg-white overflow-hidden font-Poppins">
    <aside class="fixed left-0 top-0 z-10 h-screen border-r border-white w-12 md:w-20 hover:w-48  md:hover:w-64 bg-gray-700 hover:shadow-2xl">
        <div class="flex flex-col justify-between">
            <div>
                <div class="h-16 flex items-center bg-gray-500">
                    <a href="/dashboard" class="w-max block px-2 md:px-4">
