                ...
                <div class="h-16 flex items-center bg-gray-500">
                    <a href="/dashboard">
                        <div class="w-max flex gap-4 items-center px-2 md:px-5">
                            ...
                            <marquee class="text-white ml-[12px] font-bold text-[12px] md:text-[16px]">Sistem Informasi Kos Sigura-gura IV Kav.7A</marquee>
                        </div>
                    </a>
                </div>
                <div class="mt-6">
                    <ul class="px-1 space-y-4 ml-[10px] md:ml-[20px] text-[12px] md:text-[16px] font-medium tracking-wide">
                        <li class="w-max space-y-4 hover:-translate-y-2 transition -ml-[10px] font-medium">
                            <a href="/dashboard" class="block md:w-[52px] w-[30px] ml-[5px] md:ml-0 rounded-full py-1 md:py-3 bg-sky-500">
                        ...
                        <li class="w-max">
                            <a href="/kamar">
                                <div class="flex hover:-translate-y-2 transition items-center gap-4 py-3">
                                    ...
                                    <span class='text-white ml-[15px]'>Data Kamar</span>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="w-max">
                            <a href="/tagihan">
                                <div class="flex items-center hover:-translate-y-2 transition gap-4 py-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="md:w-6 w-4 h-4 md:h-6 text-white -pl-[30px]"><path fill-rule="evenodd" d="M4.125 3C3.089 3 2.25 3.84 2.25 4.875V18a3 3 0 003 3h15a3 3 0 01-3-3V4.875C17.25 3.839 16.41 3 15.375 3H4.125zM12 9.75a.75.75 0 000 1.5h1.5a.75.75 0 000-1.5H12zm-.75-2.25a.75.75 0 01.75-.75h1.5a.75.75 0 010 1.5H12a.75.75 0 01-.75-.75zM6 12.75a.75.75 0 000 1.5h7.5a.75.75 0 000-1.5H6zm-.75 3.75a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5H6a.75.75 0 01-.75-.75zM6 6.75a.75.75 0 00-.75.75v3c0 .414.336.75.75.75h3a.75.75 0 00.75-.75v-3A.75.75 0 009 6.75H6z" clip-rule="evenodd" /><path d="M18.75 6.75h1.875c.621 0 1.125.504 1.125 1.125V18a1.5 1.5 0 01-3 0V6.75z" /></svg>
                        ...
                        <li class="w-max">
                            <a href="/pembukuan">
                                <div class="flex items-center hover:-translate-y-2 transition gap-4 py-3">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="md:w-6 w-4 h-4 md:h-6 text-white -pl-[30px]"><path d="M11.25 4.533A9.707 9.707 0 006 3a9.735 9.735 0 00-3.25.555.75.75 0 00-.5.707v14.25a.75.75 0 001 .707A8.237 8.237 0 016 18.75c1.995 0 3.823.707 5.25 1.886V4.533zM12.75 20.636A8.214 8.214 0 0118 18.75c.966 0 1.89.166 2.75.47a.75.75 0 001-.708V4.262a.75.75 0 00-.5-.707A9.735 9.735 0 0018 3a9.707 9.707 0 00-5.25 1.533v16.103z" /></svg>
                                    <span class='text-white ml-[15px]'>Pembukuan</span>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="w-max">
                            <form action="/logout" method="post">
                                @csrf
                                <button type="submit">
                                    <div class="flex bottom-0 pb-[20px] hover:-translate-y-2 transition gap-4 py-3">
