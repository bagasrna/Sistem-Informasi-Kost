...
<body>
    <div class="md:ml-[150px] ml-[80px] mr-[30px] h-screen z-40 font-Poppins">
        <h1 class='font-bold text-[20px] lg:text-[30px] mt-[30px] md:mt-[90px] '>Data Penghuni</h1>
                ...
                <div class="flex flex-col gap-4 mt-[30px] mb-4">
                    ...
                    <div>
                        <form action="/penghuni" method="GET" class="flex flex-col vsm:flex-row gap-4 mt-2 ">
                            <input type="text" name="search" value="{{ old('search')}}"
                            class="bg-gray-200 p-2 rounded shadow-sm border w-[200px] placeholder:text-[12px] sm:placeholder:text-[14px] border-gray-200 focus:outline-none"
                            placeholder="Cari Penghuni Kamar">
                            <button type="submit" class="bg-blue-400 w-[80px] hover:bg-blue-600 text-white p-2 sm:p-3 text-[12px] sm:text-[14px] rounded-lg">Search</button>
                        </form>
                    </div>
                </div>
            ...
            <table class="w-full mt-[10px]">
                ...
                <thead class="bg-gray-600 border-b-2 border-gray-200">
                    <tr class="text-white">
                        ...
                        <th class="p-3 text-md md:text-lg border border-gray-400 font-semibold tracking-wide text-center">Nomer HP</th>
                        <th class="p-3 text-md md:text-lg border border-gray-400 font-semibold tracking-wide text-center">Durasi Kos</th>
