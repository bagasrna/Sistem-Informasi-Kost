                        ...
                        <div class='ml-[20px] sm:ml-0'>
                            ...
                            <div class='mb-3 relative'>
                                ...
                                <input 
                                    ...
                                    required 
                                    class='border rounded-xl pl-8 p-3 text-[12px] sm:text-[14px] focus:ring-2 focus:ring-blue-500 placeholder:text-[12px] placeholder:sm:text-[14px] w-[250px] sm:w-[300px] outline-none border-[#A7ABB8] my-5'>
                            </div>
                        </div>
                        <div class='ml-[20px] sm:ml-0'>
                            <h1 class='font-bold text-[12px] sm:text-[16px]'>Password</h1>
                            <div class='mb-6 relative mt-[15px]'>
                                ...
                                required 
                                class='border rounded-xl pl-8 p-3 text-[12px] sm:text-[14px] placeholder:text-[12px] placeholder:sm:text-[14px] w-[250px] sm:w-[300px] focus:ring-2 focus:ring-blue-500 outline-none border-[#A7ABB8]'>
                        </div>

                        <button type='submit' class='bg-[#4172dc] mt-[10px] sm:p-3 p-2 hover:bg-[#3159b1] transition hover:-translate-y-2 sm:hover:-translate-y-3 justify-center w-full rounded-2xl text-[12px] sm:text-[14px] text-white shadow-[#536998] shadow-2xl'>Login</button>
                    </div>
                </div>
            </div>
        </form>
